...
{
    public partial class AddLogicorSupportCallLog
    {
        [Inject]
        ...
        {
            logicorSupportCallLog = new LogicorSupportCalls.Models.SQL2022_1033788_pnj.LogicorSupportCallLog();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await SQL2022_1033788_pnjService.CreateLogicorSupportCallLog(logicorSupportCallLog);
